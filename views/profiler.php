...
<div id="fuel_profiler" style="display: none;" class="<?php echo $mode; ?> closed">
	<a class="icon" href="#profiler_tab_info"><div class="icon"></div></a>
	<a class="minimal" href="#profiler_tab_info"><div class="icon"></div><?php echo $tabs['speed']->get_summary(); ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo $tabs['query']->get_title(); ?></a>
	<div class="bar">
