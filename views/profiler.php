...
<div id="fuel_profiler" style="display: none;" class="<?php echo $mode; ?> closed">
	<div class="icon" onclick="FuelPHProfiler.open_profiler();"><div class="icon"></div></div>
	<div class="minimal" onclick="FuelPHProfiler.open_profiler();"><div class="icon"></div><?php echo $tabs['speed']->get_summary(); ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo $tabs['query']->get_title(); ?></div>
	<div class="bar">
